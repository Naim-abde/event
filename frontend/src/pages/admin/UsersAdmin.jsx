          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b border-zinc-900 hover:bg-zinc-900/40 transition">
                ...
                <td className="p-4 font-semibold">Ahmed Ben</td>

                <td className="p-4 text-zinc-400">ahmed@email.com</td>

                <td className="p-4 flex gap-2">

                  <span className="px-3 py-1 rounded-full text-xs bg-zinc-800">
                    user
                  </span>

                  <button className="px-3 py-1 rounded-full text-xs bg-blue-600 hover:bg-blue-700 transition">
                    Make Admin
                  </button>

                  <button className="px-3 py-1 rounded-full text-xs bg-purple-600 hover:bg-purple-700 transition">
                    Make Organizer
                  </button>
