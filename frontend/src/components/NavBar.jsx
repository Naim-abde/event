    ...
    <nav className="bg-black text-white border-b border-white/10 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          {user ? (
            <div>
              <button className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-2 hover:bg-white/10 transition">
                <img
            ...
            <div className="hidden md:flex items-center gap-4">
              <Link
                to="/login"
                className="px-5 py-2.5 rounded-2xl border border-white/10 hover:bg-white/10 transition"
              >
                Login
              </Link>
              ...
              <Link
                to="/register"
                className="px-5 py-2.5 rounded-2xl bg-white text-black font-semibold hover:scale-105 transition"
              >
                Register
              </Link>
            </div>
